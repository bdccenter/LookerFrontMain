// src/service/bigQueryDirectService.js
import { BigQuery } from '@google-cloud/bigquery';
import 'dotenv/config';
import { fileURLToPath } from 'url'; // Añadir esta línea
import path from 'path'; // Añadir esta línea
import fs from 'fs'; // También deberías importar fs ya que lo usas más adelante
// Variables para control de caché

const __filename = fileURLToPath(import.meta.url);
const __dirname = path.dirname(__filename);

const CACHE_DURATION = 24 * 60 * 60 * 1000; // 24 horas en milisegundos (aumentado de 2 a 24)
